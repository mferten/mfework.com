...
<!-- place holder -->
        <header>
            <h1>M.F.E is a Vegan for Now. Why?</h1>
        </header>
@endpush
@push('module')
<!-- place holder -->
        <main>
            <h2 class='harvard'>Here are my Sources</h2>
            <figure>
            ...
            <figure>
                ...
                <figcaption><p class='titleColorTwo'>Whole Foods</p></figcaption>
                <figcaption><p class='harvard'>Nature</p></figcaption>
                <figcaption><p class='titleColorTwo'>Integration</p></figcaption>
            </figure>
            <figure>
